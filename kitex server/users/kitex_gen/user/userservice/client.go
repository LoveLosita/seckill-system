...
type Client interface {
	...
	TokenRefresh(ctx context.Context, req *user.TokenRefreshRequest, callOptions ...callopt.Option) (r *user.TokenRefreshResponse, err error)
}
...
func (p *kUserServiceClient) TokenRefresh(ctx context.Context, req *user.TokenRefreshRequest, callOptions ...callopt.Option) (r *user.TokenRefreshResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.TokenRefresh(ctx, req)
}
