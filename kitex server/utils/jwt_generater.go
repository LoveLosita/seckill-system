...
var RefreshKey = []byte("RefreshTokenKeyOfLink") // 用于签名和验证刷新Token的密钥
var AccessKey = []byte("AccessTokenKeyOfLink")   // 用于签名和验证访问Token的密钥
...
func ValidateRefreshToken(tokenString string) (*jwt.Token, user.Status) {
